...
import com.gabriel.domain.model.User;
import com.gabriel.domain.repository.UserRepository;
import com.gabriel.service.UserService;
import com.gabriel.service.exception.BusinessException;
import com.gabriel.service.exception.NotFoundException;
...
public class UserServiceImpl implements UserService {
    ...
    public User findById(Long aLong) {
        return this.userRepository.findById(aLong).orElseThrow(NotFoundException::new);
    }
